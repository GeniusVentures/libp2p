...
namespace libp2p::injector {
  ...
  auto makeKademliaInjector(Ts &&... args) {
    ...
    return di::make_injector<InjectorConfig>(
        ...
        di::bind<crypto::random::RandomGenerator>.TEMPLATE_TO<crypto::random::BoostRandomGenerator>(),

        di::bind<protocol::kademlia::Config>.TEMPLATE_TO<protocol::kademlia::Config>().in(di::singleton),
        di::bind<protocol::kademlia::ContentRoutingTable>.TEMPLATE_TO<protocol::kademlia::ContentRoutingTableImpl>(),
        di::bind<protocol::kademlia::PeerRoutingTable>.TEMPLATE_TO<protocol::kademlia::PeerRoutingTableImpl>(),
        di::bind<protocol::kademlia::StorageBackend>.TEMPLATE_TO<protocol::kademlia::StorageBackendDefault>(),
